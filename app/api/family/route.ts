...
export async function GET(req: NextRequest) {
  ...
  const [members, pendingRequests, incomingCheckIns, incomingSosAlerts] = await Promise.all([
  ...
  return NextResponse.json({ members, pendingRequests, incomingCheckIns, incomingSosAlerts });
}

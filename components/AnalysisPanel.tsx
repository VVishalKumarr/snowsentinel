      ...
      {open && (
        <div className="space-y-5 border-t border-slate-200 px-4 pb-5 pt-4 sm:px-5">
          <div className="flex flex-wrap gap-1.5 text-[9px] font-semibold tracking-wide">
            <span className="rounded border border-slate-300 bg-slate-50 px-2 py-0.5 text-slate-600">OBSERVED DATA</span>
            <span className="rounded border border-teal-300 bg-teal-50 px-2 py-0.5 text-teal-700">SIMULATED DATA</span>
            <span className="rounded border border-amber-300 bg-amber-50 px-2 py-0.5 text-amber-700">INFERENCE</span>
            <span className="rounded border border-slate-300 bg-slate-50 px-2 py-0.5 text-slate-600">RECOMMENDATION</span>
          </div>
